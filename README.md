...
> [!NOTE]
> This software is not _in any way_ meant to replace/devalue WakaTime!!! I love WakaTime so much and you should too! Support them [here](https://wakatime.com/pricing).
...
2. [Create an app](https://wakatime.com/apps) via WakaTime and copy your _Client ID and Secret_
